      ...
      content: (
        <div className="space-y-4">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-foreground">Welcome to the Return It Driver Team!</h3>
          ...
          <Card className="bg-white">
            ...
            <CardContent className="text-sm space-y-2">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Wear the Return It driver identification</li>
              </ul>
            </CardContent>
          </Card>
      ...
      content: (
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">You've completed the Return It driver training</p>
          </div>
