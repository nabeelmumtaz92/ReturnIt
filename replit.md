...
- **Simplified Authentication System (January 2025)**: Authentication system restored to simple, unrestricted access. All authentication methods (email/password, Google OAuth, driver signup) are always enabled for ease of use. Mobile app testing available for nabeelmumtaz92@gmail.com account.
